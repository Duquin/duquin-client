...
public class JumpCircles extends Function {
    ...
    private final Identifier CIRCLE_TEXTURE = Identifier.of("duquin", "images/circles/circle.png");
    private final Identifier CIRCLE2_TEXTURE = Identifier.of("duquin", "images/circles/circle2.png");
    private final Identifier CIRCLE3_TEXTURE = Identifier.of("duquin", "images/circles/circle3.png");
    public JumpCircles() {
