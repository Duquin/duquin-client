...
public class HUD extends Function {
    public final MultiSetting setting = new MultiSetting(
            "Элементы",
            Arrays.asList("TargetHUD", "KeyBinds", "StaffList", "PotionHUD", "ItemCoolDownHUD", "Coordinates / TPS","ArmorHUD", "Notifications"),
            new String[]{"TargetHUD", "KeyBinds", "StaffList", "PotionHUD", "ItemCoolDownHUD", "Coordinates / TPS","ArmorHUD", "Notifications"});
    ...
    public final Dragging targethudDrag = DuquinClient.getInstance().createDrag(this, "TargetHUD", 10, 45);
    public final Dragging keybindsDrag = DuquinClient.getInstance().createDrag(this, "KeyBindsHUD", 10, 95);
    public final Dragging stafflistDrag = DuquinClient.getInstance().createDrag(this, "StaffListHUD", 10, 128);
    public final Dragging itemcooldownDrag = DuquinClient.getInstance().createDrag(this, "CoolDownHUD", 10, 165);
    public final Dragging potionhudDrag = DuquinClient.getInstance().createDrag(this, "PotionHUD", 10, 198);
    public final Dragging coordinateshudDrag = DuquinClient.getInstance().createDrag(this, "CoordinatesHUD", 10, 198);
    public final Dragging armorDrag = DuquinClient.getInstance().createDrag(this, "ArmorHUD", 478, 468);
