...
import ru.levin.modules.combat.TriggerBot;
import ru.levin.modules.combat.AntiCheatBypass;
...
public class FunctionManager {
    ...
    public final AutoWarden autoWarden;
    ...
    public final AntiCheatBypass antiCheatBypass;
    ...
    public FunctionManager() {
        functions.addAll(Arrays.asList(
                ...
                antiCheatBypass = new AntiCheatBypass(),
                //Misc
                unHook = new UnHook(),
